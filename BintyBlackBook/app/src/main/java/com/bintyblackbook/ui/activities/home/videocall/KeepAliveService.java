...
//    protected static ConnectionThread mConnection;
    protected static SocketManager mSocketManager;
    ...
    private synchronized void start() {
        ...
        if (mSocketManager == null) {
            ...
            SocketManager mSocketManager = BintyBookApplication.Companion.getSocketManager();
            if (!mSocketManager.isConnected()) {
                mSocketManager.isConnected();
                Log.e("MyApplicationS","Connect");
            }
        }
    }
