...
class PromoteBusinessFragment:Fragment(), AdapterPromoteBusiness.PromoteAdapterInterface {
    ...
    private fun setAdapter() {
        rvBusiness.layoutManager= LinearLayoutManager(requireContext(),RecyclerView.VERTICAL,false)
        adapterPromoteBusiness = AdapterPromoteBusiness(requireContext(),"business")
        rvBusiness.adapter = adapterPromoteBusiness
